...
class ImportBinomialNameCSVController {
    constructor(importBinomialNameCSVUseCase) {
        this.importBinomialNameCSVUseCase = importBinomialNameCSVUseCase;
    }
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const { file } = request;
            const data = yield this.importBinomialNameCSVUseCase.execute(file);
